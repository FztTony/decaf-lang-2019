...
public interface Visitor<C> {
    ...
    //what I did: add for new class
    default void visitTLambda(Tree.TLambda that, C ctx) { visitOthers(that, ctx); }
    //finish
    ...
    //what I did: add for new class
    default void visitLambda(Tree.Lambda that, C ctx) { visitOthers(that, ctx); }
    //finish
