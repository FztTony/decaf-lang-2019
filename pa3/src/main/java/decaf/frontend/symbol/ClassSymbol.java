...
import decaf.frontend.tree.Tree.Modifiers;
...
public final class ClassSymbol extends Symbol {
    ...
    public ClassSymbol(String name, ClassType type, ClassScope scope, Pos pos, Modifiers modifiers) {
        super(name, type, pos);
    ...
    public ClassSymbol(String name, ClassSymbol parentSymbol, ClassType type, ClassScope scope, Pos pos, Modifiers modifiers) {
        super(name, type, pos);
    ...
    protected String str() {
        String mode = modifiers.toString();
        return (mode.isEmpty() ? "" : (mode + " ")) + "class " + name + parentSymbol.map(classSymbol -> " : " + classSymbol.name).orElse("");
    }
