...
class SemValue {
    enum Kind {
        ...
        LVALUE, ID, TEMPORARY //what I did: added TYPE_LIST
    }
    ...
    SemValue(Boolean flag) {
        this.kind = Kind.TEMPORARY;
        newCounts();
    }

    public void newCounts() {
        countTypeList = new LinkedList<>();
        countBool = new LinkedList<>();
    }
    ...
    //what I did: make a list to count [] and (typeList)
    Deque<Boolean> countBool;
    Deque<List<Tree.TypeLit>> countTypeList;
    /**
    ...
    public String toString() {
        String msg = switch (kind) {
            case TOKEN -> switch (code) {
                ...
                case Tokens.ARROW -> "keyword: arrow";
                //finish
